...
const AFFILIATIONS = [
  ...
  { name: "University of Groningen", link: "https://www.rug.nl/?lang=en", img: "rug.png" },
  { name: "Algorithms, Data and Democracy", link: "https://algorithms.dk/", img: "add.png" },
];

export const TeamEN: FC = () => {
  return (
    <section>
      <h2 className="fw-bolder mb-5 display-4">Who are we</h2>

      <h3 className="fw-bolder display-5">Project Team</h3>
      ...
      <h3 className="fw-bolder display-5">Affiliations</h3>
...
export const TeamDA: FC = () => {
  return (
    <section>
      <h2 className="fw-bolder mb-5 display-4">Hvem vi er</h2>

      <h3 className="fw-bolder display-5">Projektteam</h3>
      <section className="row mb-5">
        {TEAM_MEMBERS.map(({ name, title, linkedin, img }) => (
          <div key={name} className="col-6 col-sm-4 col-lg-3 mb-5">
            <img src={`${import.meta.env.BASE_URL}/team/${img}`} alt="" className="w-100" />
      ...
      <h3 className="fw-bolder display-5">Tilhørsforhold</h3>
      <section className="row align-items-center">
        {AFFILIATIONS.map(({ name, link, img }) => (
          <div key={name} className="col-12 col-sm-6 col-lg-4 mb-5">
            <a href={link}>
